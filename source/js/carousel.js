...
* https://modernizr.com/download/?-objectfit-setclasses !*/
  ...
  if (!Modernizr.objectfit) {
    var cpi__x = document.getElementsByClassName("carousel-inner");
    cpi__x[0].style.height = "60vh";
  }
...
//Load Carousel, slide every 10s
    $(document).ready(function(){
      $('.carousel').carousel({
  interval: 100000
})

//Dynamically add active class to 1st item and indicator
  ...
  $('#myCarousel .carousel-indicators li:first').addClass('active');
      ...
      if (url.match('#')) {
        // Clear active item
        $('#myCarousel .carousel-inner .item.active').removeClass('active');
        $('#myCarousel .carousel-indicators li.active').removeClass('active');
      ...
      $('#myCarousel').bind('slid', function (e) {
        ...
        window.location.hash = "#"+ parseInt($('#myCarousel .carousel-inner .item.active').index()+1);
      });
    });